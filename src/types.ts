...
export interface ImgfmtFormatOptions {
  /** Output capability token and candidate format identifier. */
  readonly id: string;
  /**
   * Output filename extension used by the default sibling-URL convention.
   * imgfmt does not create or validate the referenced file.
   */
...
export interface ImgfmtOptions {
  ...
  /** Preferred output format order. Defaults to AVIF followed by WebP. */
