...
export const supportedSourceImageExtensions: ReadonlySet<string> = new Set([
  ".apng",
  ".avif",
  ".bmp",
  ".gif",
...
export function isSupportedSourceImageUrl(value: string): boolean {
  ...
  return supportedSourceImageExtensions.has(path.slice(extensionIndex).toLowerCase());
}
